...
/**
 * An array of byte values. Non-set elements default to 0. It supports snapshots.
 * By iterating on this object, one gets the values of the array, in increasing index order.
 */
public interface SnapshottableStorageByteArrayView extends StorageByteArrayView {
